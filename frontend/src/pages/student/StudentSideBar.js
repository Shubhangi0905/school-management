    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="https://meet-clone-one.vercel.app/">
                    <ListItemIcon>
                        <VideoCallIcon color={location.pathname === ("/virtualclass") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="Virtual Class" />
                </ListItemButton>
