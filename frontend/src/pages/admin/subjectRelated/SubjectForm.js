...
const SubjectForm = () => {
    const [subjects, setSubjects] = useState([{ subName: "", subCode: "", sessions: "", classCode:"" }]);
    ...
    const handleClassCodeChange = (index) => (event) => {
        const newSubjects = [...subjects];
        newSubjects[index].classCode = event.target.value;
        setSubjects(newSubjects);
    };
                ...
                {subjects.map((subject, index) => (
                    <React.Fragment key={index}>
                        ...
                        <TextField
                                ...
                                onChange={handleClassCodeChange(index)}
                                sx={styles.inputField}
                                required
                            />
